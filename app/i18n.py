...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "choose_appointment_prompt": {
        ...
        "hi": "आपकी एक से ज़्यादा आने वाली अपॉइंटमेंट हैं। कृपया एक चुनें:",
        "hg": "Aapki ek se zyada upcoming appointments hain. Kripya ek choose karein:",
        "bn": "আপনার একাধিক আসন্ন অ্যাপয়েন্টমেন্ট আছে। অনুগ্রহ করে একটি বেছে নিন:",
    },
    "choose_appointment_button": {
        "en": "Choose",
        "hi": "चुनें",
        "hg": "Choose karein",
        "bn": "বেছে নিন",
    },
    "confirm_cancel_appointment_prompt": {
        "en": "Cancel your appointment with {doctor} on {date}?",
        "hi": "क्या आप {doctor} के साथ {date} की अपॉइंटमेंट रद्द करना चाहते हैं?",
        "hg": "Kya aap {doctor} ke saath {date} ki appointment cancel karna chahte hain?",
        "bn": "আপনি কি {doctor}-এর সাথে {date} তারিখের অ্যাপয়েন্টমেন্ট বাতিল করতে চান?",
    },
    "confirm_reschedule_appointment_prompt": {
        "en": "Reschedule your appointment with {doctor} from {old_date} to {new_date}?",
        "hi": "क्या आप {doctor} के साथ अपनी अपॉइंटमेंट {old_date} से {new_date} पर रीशेड्यूल करना चाहते हैं?",
    ...
    "appointment_status_message": {
        # Deliberately "there's an appointment for {patient}", not "{patient} has an
    ...
    "appointment_action_aborted": {
        ...
        "hg": "Koi badlaav nahi kiya gaya. Kuch aur chahiye toh koi bhi message bhejein.",
        "bn": "কোনো পরিবর্তন করা হয়নি। আরও কিছু দরকার হলে যেকোনো বার্তা পাঠান।",
    },
    "cancel_appointment_success": {
        "en": "Your appointment has been cancelled.",
        "hi": "आपकी अपॉइंटमेंट रद्द कर दी गई है।",
        "hg": "Aapki appointment cancel kar di gayi hai.",
        "bn": "আপনার অ্যাপয়েন্টমেন্ট বাতিল করা হয়েছে।",
    },
    "cancel_appointment_failed": {
        "en": "We couldn't cancel your appointment right now. Please try again or call the hospital.",
        "hi": "अभी हम आपकी अपॉइंटमेंट रद्द नहीं कर पाए। कृपया फिर कोशिश करें या अस्पताल को कॉल करें।",
        "hg": "Abhi hum aapki appointment cancel nahi kar paaye. Kripya phir try karein ya hospital ko call karein.",
        "bn": "এখন আমরা আপনার অ্যাপয়েন্টমেন্ট বাতিল করতে পারিনি। অনুগ্রহ করে আবার চেষ্টা করুন বা হাসপাতালে কল করুন।",
    },
    "reschedule_appointment_success": {
        "en": "Your appointment has been rescheduled.",
        "hi": "आपकी अपॉइंटमेंट रीशेड्यूल कर दी गई है।",
        "hg": "Aapki appointment reschedule kar di gayi hai.",
        "bn": "আপনার অ্যাপয়েন্টমেন্ট পুনঃনির্ধারণ করা হয়েছে।",
    },
    "reschedule_appointment_failed": {
        "en": "We couldn't reschedule your appointment right now. Please try again or call the hospital.",
        "hi": "अभी हम आपकी अपॉइंटमेंट रीशेड्यूल नहीं कर पाए। कृपया फिर कोशिश करें या अस्पताल को कॉल करें।",
        "hg": "Abhi hum aapki appointment reschedule nahi kar paaye. Kripya phir try karein ya hospital ko call karein.",
        "bn": "এখন আমরা আপনার অ্যাপয়েন্টমেন্ট পুনঃনির্ধারণ করতে পারিনি। অনুগ্রহ করে আবার চেষ্টা করুন বা হাসপাতালে কল করুন।",
    },
