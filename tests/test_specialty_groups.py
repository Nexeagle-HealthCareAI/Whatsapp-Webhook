...
def test_wit_nlu_integration():
    ...
    class MockDB:
        ...
        async def get_booked_appointments_for_phone(self, phone):
            # No appointments booked through this test's mock -- exercises the
            # "no active appointment" path, not full cancel/reschedule logic (out of
            # scope for this NLU-routing test).
            return []
